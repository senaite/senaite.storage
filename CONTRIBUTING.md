...
Third-party contributions are essential for keeping `senaite.storage` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.storage`. We want to keep it as easy as 
...
bugs](https://github.com/senaite/senaite.storage/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.storage/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.storage/issues).
...
The list of [open issues](https://github.com/senaite/senaite.storage/issues)
...
### Preliminaries
   ...
   https://github.com/senaite/senaite.storage/fork). This will copy the whole
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.storage.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.storage.git (push)
upstream  https://github.com/senaite/senaite.storage.git (fetch)
upstream  https://github.com/senaite/senaite.storage.git (push)
```
...
Alternatively, you can merge `senaite.storage`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.storage/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.storage/CHANGES.rst)
